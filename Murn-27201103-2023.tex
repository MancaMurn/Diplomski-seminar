...
spodnji ali zgornji meji iz izreka \ref{izrek_4.2.} ter dvema vmesnima vrednostima.
...
\begin{dokaz}
    \begin{enumerate}
        ...
        Zaradi izreka \ref{izrek_4.2.}, je dovolj pokazati 
        ...
        \Bigl \lfloor \frac{2\cdot 8 + 2}{5} \Bigr \rfloor = 3. $ Zato je, podobno kot v prvi točki, pokazati  
