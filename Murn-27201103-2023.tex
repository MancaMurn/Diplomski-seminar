...
% TODO
% graf, vozlišča in povezave, sosednje vozlišče
% komplement grafa
% komponente grafa, povezan graf
% razdalja med vozlišči d(v, w)
% inducirani podgraf
% poti, cilki, polni graf

% joint graph ??? kako je to definiran???
% Združitev grafov G in H je graf G + H, za katerega velja  V(G + H) = V(G) \cup V(H) in 
% E(G + H) = E(G) \cup E(H) \cup \{ uv | u \in G \and v \in H \} 

% Dodaj en primer z K_1
