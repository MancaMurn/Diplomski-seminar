...
\begin{itemize} \label{razredi_grafov}
    ...
    vozlišč $V(K_{n,m}) = \{ v_{1, 1}, v_{1, 2}, ... , v_{1, n},  v_{2, 1}, v_{2, 2}, ... , v_{2, m} \}$
    in povezave $E(K_{n, m}) = \{ v_{1, i} v_{2, j} \; | \; \forall i, j \in \{ 1, 2, ... , m \} \}.$ 
    \item  Polni $t$-delni graf $K_{m_1, ..., m_t}$, ima množico 
    vozlišč $V(K_{m_1, ..., m_t}) = \{ v_{1, 1}, v_{1, 2}, ... , v_{1, m_1},  v_{2, 1}, v_{2, 2}, ... , v_{2, m_2}, ... ,
     v_{t, 1}, v_{t, 2}, ... , v_{t, m_t}\}$
    in povezave $E(K_{m_1, ..., m_t}) = \{  v_{a, i} v_{b, j} \; | \;  \forall a \neq b \land \; 
    \forall i, j \in \{ 1, 2, ... , m \} \}.$
...
\begin{dokaz}
    ...
    Po lemi \ref{lema:dvojcki_razdalje} vidimo, da mora metrična baza vsebovati vse razen 
